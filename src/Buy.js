...
export default function Buy() {
    return (
        <div className="justify-center items-center min-h-screen mt-16">
            
            <div className="flex justify-center items-center mt-16">
                <h1 className="text-3xl text-blue-50 font-semibold uppercase">Let's countdown for the Pre-sale coming!</h1>
            </div>
            ...
            <div className="flex justify-center items-center mt-16">
                <h1 className="text-6xl font-bold text-green-500 uppercase">How to buy?</h1>
            </div>
            <div className="flex justify-center items-center -mt-3 mb-6">
                <p className="text-xl text-blue-50 ">Send the equivalent of BNB to the following wallets</p>
            </div>
            ...
            <div className="flex justify-center items-center">
                <h1 className="text-3xl font-semibold text-white uppercase">Metabot Token Availability</h1>
            </div>
